...
import { View, StyleSheet, ImageBackground, Text, Image, TextInput, TouchableOpacity} from "react-native";
import { connect } from "react-redux";
import { saveSearchInput, selectAllFestivals } from "../actions/filterFestivalActions.js";
    ...
    return (
      <ImageBackground style={styles.background} source={require("./festival-pic.jpg")}>
        <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.button} onPress={this.goToFestivalList}>
